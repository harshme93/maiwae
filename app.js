...
res.render("home",{ fName:foundUser.fName, lName:foundUser.lName,sName:foundUser.sName, sCourse:foundUser.sCourse,
  bDegree:foundUser.bDegree, bMajor:foundUser.bMajor, compName:foundUser.compName, compScore:foundUser.compScore,
  mDegree:foundUser.mDegree, mMajor:foundUser.mMajor, certification:foundUser.certification,date:foundUser.date,
  month:foundUser.month, year:foundUser.year, city:foundUser.city, state:foundUser.state, zip:foundUser.zip
 });
})
  } else {
    res.redirect("/");
...
User.findById(req.user.id,function(err, foundUser){
  if (err) {
    ...
    foundUser.save(function(){
      res.render("home",{
        fName:fName, bDegree:bDegree, bMajor:bMajor, compName:compName, compScore:compScore,
        mDegree:mDegree, mMajor:mMajor, certification: certification, sName:sName, sCourse: sCourse
        });
    })
  }
})
